    ...
    def get_orders(self,
        ...
        try:
            ...
            _query_parameters = {
                ...
                'startDate': options.get('start_date', None) and APIHelper.RFC3339DateTime(options.get('start_date', None)),
                'endDate': options.get('end_date', None) and APIHelper.RFC3339DateTime(options.get('end_date', None)),
